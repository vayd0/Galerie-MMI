    ...
    <nav
        ...
        <ul class="grid grid-cols-1 text-[1.4rem] gap-3 text-center items-center justify-items-center">
            ...
            @if ((Request::is('albums/*') || Request::is('photos/*')) && is_numeric(Request::segment(2)))
                <li class="nav-item hover:cursor-pointer">
                    <button onclick="openModal('addPhotoModal')"><i class="fa-solid fa-file-arrow-up"></i></button>
                </li>
            @else
                <li class="nav-item hover:cursor-pointer">
                    <button onclick="openModal('addAlbumModal')"><i class="fa-solid fa-folder-plus"></i></button>
                </li>
            @endif
            <li class="nav-item hover:cursor-pointer">
