<div class="loading fixed top-0 left-0 h-[100%] w-[100%] flex justify-center items-center z-99 transition-all duration-700"
    ...
    <svg class="w-[12rem] h-[12rem] transition-all duration-700" xmlns="http://www.w3.org/2000/svg"
        ...
        <g class="logo">
            <ellipse class="color-green" cx="640.53" cy="588.57" rx="395.24" ry="170.78" transform="rotate(-48.39)"
            ...
            <ellipse class="color-green" cx="628.16" cy="577.58" rx="170.78" ry="395.24" transform="rotate(-48.39)"
                style="animation: 0.5s loading2 ; transform-origin: 46% 50%;" />
            <ellipse class="color-black" cx="637.98" cy="585.81" rx="170.78" ry="395.24"
        ...
        <circle class="color-black" cx="625.67" cy="603.78" r="66.87" />
        <circle class="color-white" cx="673.66" cy="583.12" r="16.23" />
        <path class=
