<div id="addPhotoModal" class="fixed inset-0 hidden items-center justify-center z-50 transition-all duration-300 ease-in-out">
        ...
        <form action="{{ route('photos.add') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <div class="flex gap-2 items-center">
                    <input type="url" id="url" name="url" required
                        ...
                        class="w-full px-4 py-3 border border-gray-200 rounded-xl bg-gray-50/50 backdrop-blur-sm focus:outline-none focus:ring-2 focus:ring-darkblue/50 focus:border-darkblue focus:bg-white transition-all duration-200">
                    <label for="fileInput" class="cursor-pointer p-4 bg-blue rounded-xl hover:bg-darkblue transition-colors duration-200 flex items-center">
                        <i class="fa-solid fa-upload text-basic"></i>
                        <input type="file" id="fileInput" name="photo_file" accept="image/*" class="hidden">
                    </label>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="flex gap-2" id="starRating">
                    <i class="fa-solid fa-star text-2xl text-light-lime cursor-pointer transition-colors duration-200 hover:scale-110" data-rating="1"></i>
                    <i class="fa-solid fa-star text-2xl text-light-lime cursor-pointer transition-colors duration-200 hover:scale-110" data-rating="2"></i>
                    <i class="fa-solid fa-star text-2xl text-light-lime cursor-pointer transition-colors duration-200 hover:scale-110" data-rating="3"></i>
                    <i class="fa-solid fa-star text-2xl text-gray-300 cursor-pointer transition-colors duration-200 hover:scale-110" data-rating="4"></i>
                    <i class="fa-solid fa-star text-2xl text-gray-300 cursor-pointer transition-colors duration-200 hover:scale-110" data-rating="5"></i>
                </div>
            </div>
