                ...
                <div
                    ...
                    <div
                        ...
                        <button type="button" onclick="openModal('addAlbumModal')" class="w-full h-full">
                            <div class="bg-darkblue w-full h-[15rem] sm:h-[150px] flex justify-center items-center border border-darkblue rounded-xl hover:bg-basic hover:border-3 transition-all duration-300 text-basic hover:text-blue"
                                id="add-album">
